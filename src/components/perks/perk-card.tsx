      ...
      <div className="flex h-full w-full flex-col overflow-hidden rounded-xl bg-white border border-gray-200/60 shadow-sm transition-all duration-200 ease-out group-hover:shadow-lg group-hover:border-gray-300/80 group-hover:-translate-y-1">
        ...
        <div className="border-b border-gray-100 bg-gray-50/50 p-3 sm:p-4">
          <div className="flex gap-3 sm:gap-4">
            ...
            <div className="flex min-w-0 flex-1 flex-col justify-center gap-0.5 sm:gap-1">
              <h3 className="text-[13px] sm:text-sm font-semibold leading-5 text-gray-900">
                {providerName}
              </h3>
              {categoryName && (
        ...
        <div className="flex flex-1 flex-col gap-1.5 sm:gap-2 p-3 sm:p-4">
          ...
          <div className="flex flex-col gap-0.5 sm:gap-1">
            <h4 className="text-sm sm:text-[15px] font-semibold leading-snug text-gray-900 line-clamp-2">
              {perk.title || 'Untitled Perk'}
            </h4>
            <p className="text-[13px] sm:text-sm text-gray-500 leading-relaxed line-clamp-2 sm:line-clamp-3">
              {description}
            </p>
          </div>
        ...
        {/* Footer with action */}
        <div className="border-t border-gray-100 bg-gray-50/30 px-3 sm:px-4 py-2">
          <span className="text-[13px] sm:text-sm font-medium text-indigo-600 group-hover:text-indigo-700 transition-colors duration-150">
            View offer →
          </span>
        </div>
      </div>
