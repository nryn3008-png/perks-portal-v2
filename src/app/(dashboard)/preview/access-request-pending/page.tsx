...
/**
 * Preview: Access Restricted — Pending Request
 *
 * Shows the access-restricted page as seen by a user who has already
 * submitted an access request and is waiting for review.
 *
 * URL: /preview/access-request-pending
 */
...
export default function AccessRequestPendingPreview() {
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="grid grid-cols-2 gap-4 rounded-lg bg-white/80 border border-[#0038FF]/10 p-4">
                <div>
                  ...
                  <p className="text-[13px] font-medium text-gray-900">Acme Startup Inc.</p>
                </div>
                <div>
                  <p className="text-[11px] font-medium text-[#0038FF]/60 uppercase tracking-wider">VC / Investor</p>
                  <p className="text-[13px] font-medium text-gray-900">Techstars</p>
                </div>
              </div>
